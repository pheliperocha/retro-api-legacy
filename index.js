...
/*
 ...
 |--------------------------------------------------------------------------
 */
app.get('/facilitador/:userId/retrospective', function(req, res) {
...
app.get('/retrospective/:id', function(req, res) {
...
app.get('/retrospective/:id/list', function(req, res) {
...
app.get('/retrospective/:id/card', function(req, res) {
